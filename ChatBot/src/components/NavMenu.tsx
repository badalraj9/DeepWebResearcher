...
export const NavMenu = ({ onLibraryOpen, onHomeOpen, recentItems }: NavMenuProps) => {
  ...
  return (
    <>
      {/* Home Logo Button - Bottom right corner */}
      <button
        onClick={onHomeOpen}
        className="home-logo hidden md:flex"
        title="Go Home"
      >
        🏠
      </button>
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="space-y-2">
                ...
                <button
                  ...
                  className="w-full p-2 rounded-lg bg-secondary text-secondary-foreground hover:bg-secondary/90 transition-colors"
                >
                  Go Home
                </button>
              </div>
