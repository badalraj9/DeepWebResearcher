...
import { Search, NotepadText, FileStack, Upload, X, FileText } from 'lucide-react';
...
const categories = [
  ...
  { id: "latex-detailed-report", label: "LaTeX Detailed Report", icon: <FileText size={16} /> },
  { id: "latex-executive-summary", label: "LaTeX Executive Summary", icon: <FileText size={16} /> }
];
