...
interface TextEditorProps {
  ...
  isLatexReport?: boolean;
  isLatexExecutiveSummary?: boolean;
}
...
export const TextEditor = ({ initialContent = '', onContentChange, isLatexReport = false, isLatexExecutiveSummary = false }: TextEditorProps) => {
  ...
  return (
    <motion.div 
      ...
      } ${isLatexReport ? 'latex-report' : ''} ${isLatexExecutiveSummary ? 'latex-executive-summary' : ''}`}
